...
const config = {
  ...
  theme: {
    extend: {
      colors: {
        // Palette brand pilotée par CSS vars (triplets RGB) — thémable par business
        // sur la vitrine via --biz-brand-* ; fallback = émeraude par défaut.
        brand: {
          DEFAULT: 'rgb(var(--biz-brand-600) / <alpha-value>)',
          50: 'rgb(var(--biz-brand-50) / <alpha-value>)',
          100: 'rgb(var(--biz-brand-100) / <alpha-value>)',
          200: 'rgb(var(--biz-brand-200) / <alpha-value>)',
          300: 'rgb(var(--biz-brand-300) / <alpha-value>)',
          400: 'rgb(var(--biz-brand-400) / <alpha-value>)',
          500: 'rgb(var(--biz-brand-500) / <alpha-value>)',
          600: 'rgb(var(--biz-brand-600) / <alpha-value>)',
          700: 'rgb(var(--biz-brand-700) / <alpha-value>)',
          800: 'rgb(var(--biz-brand-800) / <alpha-value>)',
          900: 'rgb(var(--biz-brand-900) / <alpha-value>)',
          950: 'rgb(var(--biz-brand-950) / <alpha-value>)',
        },
      ...
      animation: {
        ...
        'enter-from-right': 'enterFromRight 0.3s ease-out',
        'enter-from-left': 'enterFromLeft 0.3s ease-out',
        'exit-to-right': 'exitToRight 0.3s ease-in',
        'exit-to-left': 'exitToLeft 0.3s ease-in',
