    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center px-4">
        ...
        >
          ...
          <h2 className="text-2xl font-display font-bold text-gray-900 dark:text-white tracking-tight mb-2">
            Panier vide
          </h2>
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center justify-between">
        ...
        <button
          onClick={handleClear}
          className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 text-xs font-medium hover:bg-red-500/20 transition-all active:scale-[0.98]"
        >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-start gap-3">
                        ...
                        <button
                          ...
                          className="shrink-0 w-8 h-8 rounded-xl flex items-center justify-center text-gray-400 dark:text-white/20 hover:text-red-400 hover:bg-red-400/10 transition-all active:scale-95"
                        >
                      ...
                      <div className="flex items-center justify-between mt-3">
                        <div className="flex items-center gap-1">
                          <button
                            ...
                            className="w-8 h-8 rounded-xl bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 flex items-center justify-center text-gray-500 dark:text-white/50 hover:text-gray-900 dark:text-white hover:bg-gray-100 dark:bg-white/10 active:scale-95 transition-all disabled:opacity-30"
                          >
                          ...
                          <button
                            onClick={() => updateQuantity(item.productId, item.quantity + 1)}
                            className="w-8 h-8 rounded-xl bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 flex items-center justify-center text-gray-500 dark:text-white/50 hover:text-gray-900 dark:text-white hover:bg-emerald-500/20 active:scale-95 transition-all"
                          >
