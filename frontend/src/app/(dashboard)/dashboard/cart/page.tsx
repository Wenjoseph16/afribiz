    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center px-4">
        ...
        >
          ...
          <div className="relative rounded-[2rem] bg-white/5 border border-white/10 p-1.5">
            <div className="relative rounded-[calc(2rem-0.375rem)] bg-gradient-to-br from-white/[0.03] to-white/[0.01] border border-white/[0.06] p-12">
              <div className="absolute inset-0 bg-gradient-to-b from-emerald-500/5 via-transparent to-transparent pointer-events-none rounded-[calc(2rem-0.375rem)]" />
              <div className="relative">
                ...
                <Link href="/marketplace">
                  <button className="group inline-flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-to-r from-emerald-500 to-emerald-400 text-white font-bold text-base tracking-tight shadow-[0_0_30px_rgba(16,185,129,0.25)] hover:shadow-[0_0_50px_rgba(16,185,129,0.4)] transition-all duration-500 active:scale-[0.98]">
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center justify-between">
        ...
        <button
          onClick={handleClear}
          className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 text-xs font-medium hover:bg-red-500/20 hover:border-red-500/30 transition-all duration-200 active:scale-[0.98]"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="relative rounded-2xl bg-white/[0.03] border border-white/[0.06] p-1.5 hover:border-emerald-500/20 transition-all duration-300">
                  <div className="relative rounded-[calc(1rem-0.1875rem)] bg-gradient-to-br from-white/[0.02] to-transparent p-4">
                    ...
                    <div className="relative flex items-center gap-4">
                      {/* Image */}
                      <div className="relative w-20 h-20 rounded-xl bg-white/5 border border-white/10 overflow-hidden shrink-0">
                        {item.image ? (
                          <Image
                            src={item.image}
                            alt={item.name}
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-start gap-3">
                          ...
                          <button
                            ...
                            className="shrink-0 w-8 h-8 rounded-xl flex items-center justify-center text-white/20 hover:text-red-400 hover:bg-red-400/10 transition-all duration-200 active:scale-95"
                          >
                        ...
                        <div className="flex items-center justify-between mt-3">
                          <div className="flex items-center gap-1">
                            <button
                              ...
                              className="w-8 h-8 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-white hover:bg-white/10 hover:border-white/20 active:scale-95 transition-all duration-150 disabled:opacity-30 disabled:cursor-not-allowed"
                            >
                            ...
                            <button
                              onClick={() => updateQuantity(item.productId, item.quantity + 1)}
                              className="w-8 h-8 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-white hover:bg-emerald-500/20 hover:border-emerald-500/30 active:scale-95 transition-all duration-150"
                            >
        ...
        <motion.div variants={itemVariants} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="h-2 rounded-full bg-white/5 overflow-hidden">
                    <motion.div
                      ...
                      className="h-full rounded-full bg-gradient-to-r from-emerald-500 to-emerald-400 shadow-[0_0_16px_rgba(16,185,129,0.4)]"
                    />
                  </div>
                </div>
              ) : (
          ...
          {/* Récapitulatif */}
          <div className="relative rounded-2xl bg-white/[0.03] border border-white/[0.06] p-1.5">
            <div className="relative rounded-[calc(1rem-0.1875rem)] bg-gradient-to-br from-white/[0.02] to-transparent p-5 space-y-3">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className={cn('font-medium tabular-nums', total >= FREE_SHIPPING_THRESHOLD ? 'text-emerald-400' : 'text-white/70')}>
              ...
              <div className="flex justify-between items-baseline pt-1">
                ...
                <span className="text-2xl font-bold text-white tabular-nums">
                  {formatPrice(total + (total >= FREE_SHIPPING_THRESHOLD ? 0 : 2500), currency)}
                </span>
              </div>
            </div>
          </div>
          ...
          {/* CTA */}
          <Link href="/checkout">
            <button className="group relative w-full h-14 rounded-2xl bg-gradient-to-r from-emerald-500 to-emerald-400 text-white font-bold text-base tracking-tight overflow-hidden transition-all duration-300 hover:shadow-[0_0_40px_rgba(16,185,129,0.35)] active:scale-[0.98]">
