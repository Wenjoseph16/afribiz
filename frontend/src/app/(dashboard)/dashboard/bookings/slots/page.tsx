  ...
  return (
    <div className="animate-fade-in space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          { label: 'Créneaux', value: daySlots.length },
          { label: 'Jour', value: DAYS[selectedDay] },
          {
            label: 'Début',
            value:
              daySlots.length > 0
                ? daySlots.reduce((a: any, s: any) => (s.startTime < a ? s.startTime : a), '23:59')
                : '—',
          },
          {
            label: 'Fin',
            value:
              daySlots.length > 0
                ? daySlots.reduce((a: any, s: any) => (s.endTime > a ? s.endTime : a), '00:00')
                : '—',
          },
        ].map((s) => (
      ...
      <Modal
        ...
        title={editSlot ? 'Modifier le créneau' : 'Nouveau créneau'}
      >
