  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-lg opacity-80">
                /{DURATION_LABELS[p.duration]?.toLowerCase() || p.duration.toLowerCase()}
              </span>
            </div>
            <div className="flex flex-wrap gap-4 text-sm opacity-90">
              <div className="flex items-center gap-1.5">
                <Users className="h-4 w-4" />
                {p.subscriberCount || 0} abonné{(p.subscriberCount || 0) !== 1 ? 's' : ''}
              </div>
              <div className="flex items-center gap-1.5">
              ...
              {p.subscriberCount > 0 && (
                <div className="flex items-center gap-1.5">
                  ...
                  Revenu : {(Number(p.price) * (p.subscriberCount || 0)).toLocaleString()} FCFA
                </div>
              )}
            </div>
          </div>
            ...
            <Card padding="lg">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-gray-900 dark:text-gray-100">
                    {p.maxEmployees || 'Illimité'}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500">Stockage</span>
                  <span className="font-medium text-gray-900 dark:text-gray-100">
                    {p.maxStorage ? `${p.maxStorage} Go` : 'Illimité'}
                  </span>
                </div>
                {p.subscriberCount > 0 && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-900 dark:text-gray-100">
                      {(Number(p.price) * (p.subscriberCount || 0)).toLocaleString()} FCFA
                    </span>
                  </div>
                )}
              </div>
      ...
      <ConfirmationModal
        ...
        description="Cette action est irréversible. Les abonnés à ce plan seront affectés."
