    ...
    return (
      <div className="max-w-5xl mx-auto space-y-6 animate-fade-in flex flex-col items-center justify-center py-20">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Le module que vous recherchez n&apos;existe pas ou a été retiré.
        </p>
              ...
              <div className="flex items-center gap-2">
                <Button size="lg" onClick={handleInstall} isLoading={installMutation.isPending}>
                  ...
                  {installMutation.isPending
                    ...
                    : isFree
                      ? 'Installer'
                      : `Acheter ${mod.price?.toLocaleString()} FCFA`}
                </Button>
                <button
            ...
            <>
              <Card>
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400 whitespace-pre-line leading-relaxed">
                  {mod.fullDescription || mod.shortDescription || mod.description}
                </div>
              </Card>
                      ...
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-gray-900 dark:text-gray-100">
                            {review.user?.name || review.user || 'Utilisateur'}
                          </span>
                        </div>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                {mod.developer?.createdAt && (
                  <p className="text-xs text-gray-500">
                    Membre depuis {new Date(mod.developer.createdAt).getFullYear()}
                  </p>
                )}
              </div>
            </div>
          ...
          <Card>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-gray-100">
                  {mod.updatedAt ? new Date(mod.updatedAt).toLocaleDateString('fr-FR') : '—'}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-500">Licence</span>
                <span className="font-medium text-gray-900 dark:text-gray-100">
                  {mod.license || 'Standard'}
                </span>
              </div>
            </div>
          </Card>
