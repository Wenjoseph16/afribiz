...
const benefits = [
  {
    ...
    desc: "Touchez des milliers de clients à travers l'Afrique de l'Ouest.",
  },
  {
    icon: ShoppingBag,
    title: 'Vendez facilement',
    desc: 'Gérez vos produits, services et réservations depuis une plateforme unique.',
  },
  {
    icon: BarChart3,
    title: 'Analytics avancés',
    desc: 'Suivez vos ventes, votre trafic et la performance de votre business.',
  },
  {
    icon: Shield,
    title: 'Paiements sécurisés',
    desc: 'Acceptez Wave, Flooz, TMoney et plus via notre système escrow.',
  },
  {
    icon: Users,
    title: 'Fidélisation',
    desc: 'Créez des programmes de fidélité et fidélisez votre clientèle.',
  },
  {
    icon: TrendingUp,
    title: 'Croissance',
    desc: 'Les business AfriBiz génèrent en moyenne 850 000 FCFA/mois.',
  },
];
    ...
    <div className="animate-fade-in">
      ...
      <div className="bg-gradient-to-br from-emerald-700 via-emerald-600 to-emerald-800 rounded-xl p-8 md:p-12 text-white mb-8">
        <div className="max-w-2xl">
          <h2 className="text-2xl md:text-3xl font-bold mb-3">Lancez votre business en ligne</h2>
          <p className="text-emerald-100 mb-6">
            Rejoignez les 500+ business qui vendent déjà sur AfriBiz et profitez d&apos;une
            plateforme conçue pour le marché africain.
          </p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-8 border border-white/20">
            ...
            <p className="text-xs text-emerald-100">
              AffriBiz ne facture <strong>aucun abonnement</strong>. Prélevez seulement{' '}
              <strong>1%</strong> sur les transactions et <strong>2%</strong> sur les escrows. Le
      ...
      <h3 className="text-lg font-bold text-gray-900 mb-6">
        Pourquoi devenir business sur AfriBiz ?
      </h3>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        {benefits.map((benefit, i) => (
          <div
            key={i}
            className="bg-white rounded-xl border border-gray-200 p-6 hover:border-emerald-200 hover:shadow-md transition-all duration-200"
          >
