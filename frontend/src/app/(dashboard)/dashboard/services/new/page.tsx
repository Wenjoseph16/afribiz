  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload: any = {
        ...
        promotionalPrice:
          form.isPromotional && form.promotionalPrice ? Number(form.promotionalPrice) : undefined,
        discountPercent: form.isPromotional ? Number(form.discountPercent) : 0,
        promotionEndsAt:
          form.isPromotional && form.promotionEndsAt ? form.promotionEndsAt : undefined,
        ...
        depositAmount:
          form.depositRequired && form.depositAmount ? Number(form.depositAmount) : undefined,
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="sm:col-span-2">
              ...
              <textarea
                ...
                rows={2}
                maxLength={200}
                placeholder="Brève description (200 caractères max)"
              />
            </div>
            <div className="sm:col-span-2">
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  type="button"
                  onClick={addTag}
                  className="px-3 py-2 rounded-xl bg-brand/10 text-brand text-sm font-medium hover:bg-brand/20 transition-colors"
                >
                  +
                </button>
              </div>
          ...
          <div className="mt-4">
            <button
              ...
              onClick={() => {
                ...
                if (!showPromo) update('isPromotional', true);
                else update('isPromotional', false);
              }}
              className={cn(
                'text-sm font-medium transition-colors',
                showPromo ? 'text-red-500' : 'text-brand'
              )}
            >
            ...
            {showPromo && (
              <div className="mt-3 grid grid-cols-1 sm:grid-cols-3 gap-4 p-4 bg-red-50 dark:bg-red-900/10 rounded-xl border border-red-100 dark:border-red-900/20">
                ...
                {form.price &&
                  ...
                  Number(form.promotionalPrice) < Number(form.price) && (
                    <div className="sm:col-span-3 text-xs text-green-600 bg-green-50 dark:bg-green-900/10 px-3 py-2 rounded-lg">
                      ...
                      <span className="font-bold text-red-500">
                        {Number(form.promotionalPrice).toLocaleString()} FCFA
                      </span>
                      {!form.discountPercent &&
                        ` (${Math.round((1 - Number(form.promotionalPrice) / Number(form.price)) * 100)}% de réduction)`}
                    </div>
                  )}
              </div>
            )}
        ...
        <Card>
          ...
          <p className="text-xs text-gray-400 mt-2">
            Ex: Coupe homme = 30min, Massage complet = 60min, Formation = plusieurs heures
          </p>
        </Card>
          ...
          <div className="space-y-4">
            <label className="flex items-start gap-3 p-3 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-brand/30 transition-colors cursor-pointer">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Le client doit réserver avant de venir</p>
              </div>
            </label>
            <label className="flex items-start gap-3 p-3 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-brand/30 transition-colors cursor-pointer">
              <input
            ...
            <label className="flex items-start gap-3 p-3 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-brand/30 transition-colors cursor-pointer">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Le client paie un acompte pour réserver</p>
              </div>
            </label>
        ...
        <Card>
          ...
          <div className="space-y-2">
            {form.employees.map((emp: any, i: number) => (
              <div
                key={i}
                className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-xl"
              >
        ...
        <Card>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              <Input
                label="Titre SEO (balise titre)"
                value={form.seoTitle}
                onChange={(e) => update('seoTitle', e.target.value)}
                placeholder="Ex: Coiffure homme professionnel - Mon Business"
              />
            </div>
            <div className="sm:col-span-2">
              ...
              <textarea
                ...
                rows={2}
                maxLength={160}
                placeholder="Courte description pour les moteurs de recherche (160 caractères max)"
              />
            </div>
          </div>
        </Card>
