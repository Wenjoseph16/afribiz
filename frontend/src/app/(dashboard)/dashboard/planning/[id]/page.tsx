      ...
      <div className="bg-gradient-to-br from-brand-700 to-emerald-800 rounded-2xl p-8 text-white">
        <div className="flex items-start justify-between">
          <div className="space-y-3">
            ...
            {isOverdue && (
              <span className="inline-block px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-500/30 text-white">
                🔴 En retard
              </span>
            )}
            {t.createdAt &&
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span
                    className={cn(
                      'font-medium',
                      isOverdue ? 'text-red-500' : 'text-gray-900 dark:text-gray-100'
                    )}
                  >
                    {dueDate.toLocaleDateString('fr-FR')}
                  </span>
