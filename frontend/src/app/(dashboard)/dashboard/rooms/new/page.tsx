      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card>
          <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-4">
            <BedDouble className="h-4 w-4 inline mr-1.5" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              <Input
                ...
                placeholder="Ex: Chambre Deluxe Océan, Suite Présidentielle..."
                required
              />
            </div>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-brand/20 focus:border-brand outline-none bg-transparent dark:text-gray-100"
                >
                  {ROOM_TYPES.map((t) => (
            ...
            <div className="sm:col-span-2">
              ...
              <textarea
                ...
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-brand/20 focus:border-brand outline-none resize-none bg-transparent dark:text-gray-100"
                rows={2}
                maxLength={300}
            ...
            <div className="sm:col-span-2">
              ...
              <textarea
                ...
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-brand/20 focus:border-brand outline-none resize-none bg-transparent dark:text-gray-100"
                rows={4}
                placeholder="Description détaillée de la chambre, équipements, vue, etc."
              />
            </div>
          </div>
        </Card>
              ...
              <button
                ...
                className={cn(
                  ...
                  selectedAmenities.includes(a)
                    ...
                    : 'bg-gray-50 dark:bg-gray-700/50 text-gray-600 dark:text-gray-300 border-gray-200 dark:border-gray-600 hover:border-brand/30'
                )}
              >
                {a}
              </button>
