    ...
    try {
      await updateRoom.mutateAsync({
        ...
        data: {
          ...
          promotionalPrice:
            showPromo && form.promotionalPrice ? Number(form.promotionalPrice) : null,
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-semibold">Informations principales</h3>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-brand/20 focus:border-brand outline-none bg-transparent dark:text-gray-100"
                >
                  {ROOM_TYPES.map((t) => (
            ...
            <div className="sm:col-span-2">
              ...
              <textarea
                ...
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-brand/20 focus:border-brand outline-none resize-none bg-transparent dark:text-gray-100"
                rows={2}
                maxLength={300}
              />
            </div>
        ...
        <Card>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <Input
              label="Week-end"
              type="number"
              value={form.priceWeekend?.toString() || ''}
              onChange={(e) => update('priceWeekend', e.target.value)}
            />
            <Input
              label="Haute saison"
              type="number"
              value={form.priceHighSeason?.toString() || ''}
              onChange={(e) => update('priceHighSeason', e.target.value)}
            />
            <Input
              label="Basse saison"
              type="number"
              value={form.priceLowSeason?.toString() || ''}
              onChange={(e) => update('priceLowSeason', e.target.value)}
            />
          ...
          <div className="mt-4">
            ...
            >
              {showPromo ? '— Masquer promo' : '+ Ajouter promo'}
            </button>
            {showPromo && (
              <div className="mt-3 grid grid-cols-1 sm:grid-cols-3 gap-4 p-4 bg-red-50 dark:bg-red-900/10 rounded-xl border border-red-100">
                <Input
                  label="Prix promo"
                  type="number"
                  value={form.promotionalPrice?.toString() || ''}
        ...
        <Card>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-semibold">Capacité & Configuration</h3>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <Input
              label="Capacité max"
            ...
            <div>
              <label className="block text-sm font-medium mb-2">
                <Bath className="h-3.5 w-3.5 inline mr-1" />
                Salle de bain
              </label>
              <select
                value={form.bathroom || 'PRIVATE'}
                onChange={(e) => update('bathroom', e.target.value)}
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-brand/20 focus:border-brand outline-none bg-transparent dark:text-gray-100"
              >
                <option value="PRIVATE">Privée</option>
                <option value="SHARED">Partagée</option>
                <option value="COMMUNAL">Commune</option>
              </select>
            </div>
            <div className="flex items-center gap-3 pt-6">
              <label className="flex items-center gap-2 text-sm">
                <input
                  type="checkbox"
                  checked={form.breakfastIncluded || false}
              ...
              <button
                ...
                className={cn(
                  ...
                  selectedAmenities.includes(a)
                    ...
                    : 'bg-gray-50 dark:bg-gray-700/50 text-gray-600 border-gray-200 dark:border-gray-600 hover:border-brand/30'
                )}
              >
                {a}
              </button>
        ...
        <Card>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-semibold">Check-in / Check-out</h3>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Input
              label="Check-in"
        ...
        <Card>
          ...
          <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-8 text-center hover:border-brand/40 transition-colors">
            ...
            <p className="text-sm text-gray-500">Photos de la chambre</p>
        ...
        <Card>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-semibold">Visibilité & SEO</h3>
          </div>
