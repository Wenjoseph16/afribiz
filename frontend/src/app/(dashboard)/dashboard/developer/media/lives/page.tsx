  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card padding="md">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-gray-500 dark:text-gray-400">Total lives</p>
              <p className="text-lg font-bold text-gray-900 dark:text-gray-100">{lives.length}</p>
            </div>
          </div>
        </Card>
        <Card padding="md">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-gray-500 dark:text-gray-400">Spectateurs</p>
        ...
        <Card padding="md">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-gray-500 dark:text-gray-400">Pic viewers</p>
              <p className="text-lg font-bold text-gray-900 dark:text-gray-100">0</p>
            </div>
          </div>
        </Card>
      ...
      <EmptyState
        ...
        action={
          <Button variant="gradient" onClick={() => setShowPlanner(true)}>
