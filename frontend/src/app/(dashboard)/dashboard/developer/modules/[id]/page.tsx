...
export default function ModuleDetailPage() {
  ...
  const moduleLogo = mod?.logo;
  const moduleImages = (mod as Record<string, any>)?.images || [];
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <Card className="p-4">
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-500">
        ...
        <div className="flex items-center justify-between mb-5">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              isLoading={uploadingScreenshots}
            >
          ...
          {moduleImages.length > 0 ? (
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
              {moduleImages.map((img: string, idx: number) => (
                <div
                  key={idx}
                  className="relative group aspect-video rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800"
                >
                  <Image
                    src={img}
                    alt={`Capture ${idx + 1}`}
        ...
        <Card padding="lg">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium text-gray-900 dark:text-gray-100">
                {PRICING_LABELS[mod.pricingType as ModulePricingType] || mod.pricingType}
              </span>
            </div>
            <div className="flex justify-between text-sm">
        ...
        <Card padding="lg">
          ...
          {permissionList.length === 0 ? (
            <EmptyState
              ...
              description="Ce module ne déclare pas encore de permissions."
            />
          ) : (
            <div className="space-y-2">
              {permissionList.slice(0, 5).map((p: any) => (
                <div
                  key={p.id}
                  className="flex items-center justify-between p-2.5 rounded-xl bg-gray-50 dark:bg-gray-800/50"
                >
                  <div className="flex items-center gap-2">
              ...
              {permissionList.length > 5 && (
                <p className="text-xs text-gray-400 text-center">
                  +{permissionList.length - 5} autres
                </p>
              )}
            </div>
          )}
        ...
        <Card padding="lg">
          ...
          {versionList.length === 0 ? (
            <EmptyState
              ...
              description="Aucune version publiée pour ce module."
            />
          ) : (
            <div className="space-y-2">
        ...
        <Card padding="lg">
          ...
          {activityList.length === 0 ? (
            <EmptyState
              ...
              description="Aucune activité récente pour ce module."
            />
          ) : (
            <div className="space-y-2">
