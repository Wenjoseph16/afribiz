...
export default function DeveloperDashboardPage() {
  ...
  const overview = useMemo(() => {
    ...
    return {
      ...
      averageRating:
        o.averageRating ?? dashboard.reviews?.averageRating ?? dashboard.reviews?.average ?? 0,
    };
  }, [dashboard]);
  ...
  const statsCards = [
    ...
    },
    {
      ...
      value: safeOverview.averageRating.toFixed(1) + ' / 5',
  ...
  return (
    <div className="animate-fade-in space-y-6">
      <PageHeader
        ...
        breadcrumbs={[{ label: 'Dashboard', href: '/dashboard' }, { label: 'Développeur' }]}
        actions={
      ...
      <div className="grid lg:grid-cols-2 gap-6">
          ...
          {recentModules.length === 0 ? (
            ...
            <div className="space-y-2">
              {recentModules.map((mod: DeveloperModule) => (
                ...
                >
                  <div className="relative w-10 h-10 rounded-lg bg-gradient-to-br from-brand-50 to-purple-50 dark:from-brand-900/30 dark:to-purple-900/30 flex items-center justify-center shrink-0 overflow-hidden">
                    {mod.logo ? (
                      <Image
                        src={mod.logo ?? ''}
                        alt={mod.name}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-400">
                      {mod.price
                        ...
                        : PRICING_LABELS[mod.pricingType]}
        ...
        <Card padding="lg">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link
              href="/dashboard/developer/installations"
              className="text-xs font-medium text-brand hover:text-brand-700 transition-colors"
            >
              Voir tout →
            </Link>
        ...
        <Card padding="lg">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link
              href="/dashboard/developer/revenues"
              className="text-xs font-medium text-brand hover:text-brand-700 transition-colors"
            >
              Voir tout →
            </Link>
        ...
        <Card padding="lg">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link
              href="/dashboard/developer/reviews"
              className="text-xs font-medium text-brand hover:text-brand-700 transition-colors"
            >
              Voir tout →
            </Link>
          ...
          {recentReviews.length === 0 ? (
            ...
            <div className="space-y-2">
              {recentReviews.map((review: DeveloperModuleReview) => (
                <div
                  key={review.id}
                  className="p-2.5 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors"
                >
                  <div className="flex items-center gap-3">
              ...
              {recentTickets.map((ticket: any) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-400">
                      {ticket.business?.name && `${ticket.business.name} · `}
