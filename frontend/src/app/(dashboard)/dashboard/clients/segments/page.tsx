...
export default function SegmentsPage() {
  ...
  const [deleteSegmentTarget, setDeleteSegmentTarget] = useState<string | null>(null);
  ...
  const handleSave = async () => {
    ...
    if (form.conditions.lastOrderDays)
      conditions.lastOrderDays = Number(form.conditions.lastOrderDays);
  ...
  return (
    <div className="space-y-6 animate-fade-in">
        ...
        <Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <input
                type="text"
                placeholder="Ex: VIP, Nouveaux, Inactifs..."
                value={form.name}
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({
                        ...form,
                        conditions: { ...form.conditions, minOrders: e.target.value },
                      })
                    }
                    className="w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand/20"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({
                        ...form,
                        conditions: { ...form.conditions, minSpent: e.target.value },
                      })
                    }
                    className="w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand/20"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({
                        ...form,
                        conditions: { ...form.conditions, maxSpent: e.target.value },
                      })
                    }
                    className="w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand/20"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({
                        ...form,
                        conditions: { ...form.conditions, lastOrderDays: e.target.value },
                      })
                    }
                    className="w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand/20"
                  />
          ...
          <div className="flex justify-end gap-2 mt-6">
            ...
            <Button
              onClick={handleSave}
              disabled={!form.name || createSegment.isPending || updateSegment.isPending}
            >
            ...
            <Card key={seg.id}>
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex gap-1">
                  ...
                  <button
                    onClick={() => setDeleteSegmentTarget(seg.id)}
              ...
              <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-700">
                ...
                {seg.isDynamic && (
                  ...
                  >
                    <RotateCw
                      className={cn('h-3 w-3', recalculateSegment.isPending && 'animate-spin')}
                    />
                    Recalculer
                  </button>
                )}
      ...
      <ConfirmationModal
        ...
        onConfirm={async () => {
          if (deleteSegmentTarget) {
            await deleteSegment.mutateAsync(deleteSegmentTarget);
            setDeleteSegmentTarget(null);
          }
        }}
        title="Supprimer ce segment ?"
        description="Cette action est irréversible. Tous les clients associés à ce segment seront désaffectés."
