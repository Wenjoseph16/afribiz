...
import { MapPin, Plus, Pencil, Trash2, Loader, DollarSign, Clock, Save, X } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-fade-in">
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-right">
                      <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <button
                          onClick={() => setDeleteZoneTarget(zone.id)}
      ...
      <ConfirmationModal
        ...
        onConfirm={async () => {
          if (deleteZoneTarget) {
            await deleteMutation.mutateAsync(deleteZoneTarget);
            setDeleteZoneTarget(null);
          }
        }}
        title="Supprimer cette zone ?"
        description="Cette action est irréversible. La zone de livraison sera définitivement supprimée."
