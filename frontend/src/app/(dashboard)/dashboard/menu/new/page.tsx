...
export default function NewMenuItemPage() {
  ...
  const addVariant = () => {
    setVariants((prev) => [
      ...prev,
      { name: '', type: 'SIZE', price: 0, currency: 'FCFA', isAvailable: true },
    ]);
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createMenuItem.mutateAsync({
        ...
        promotionalPrice:
          showPromo && form.promotionalPrice ? Number(form.promotionalPrice) : undefined,
  ...
  return (
    <div className="animate-fade-in space-y-6 max-w-4xl">
      <PageHeader
        title="Nouveau plat"
        description="Ajoutez un plat ou une boisson à votre menu"
        breadcrumbs={[
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="p-6 space-y-4">
            <h2 className="font-semibold text-gray-900 dark:text-white flex items-center gap-2">
              <Utensils className="w-4 h-4 text-brand" /> Informations
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="sm:col-span-2">
                ...
                <Input
                  ...
                  placeholder="Ex: Poulet Braisé, Riz Sauté..."
                  required
                />
              </div>
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-brand/20 focus:border-brand outline-none resize-none bg-transparent dark:text-gray-100"
                  rows={2}
                  maxLength={200}
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-brand/20 focus:border-brand outline-none resize-none bg-transparent dark:text-gray-100"
                  rows={4}
                  placeholder="Ingrédients, saveurs, origine..."
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
          ...
          <Card className="p-6 space-y-4">
            <h2 className="font-semibold text-gray-900 dark:text-white flex items-center gap-2">
              <DollarSign className="w-4 h-4 text-brand" /> Tarification
            </h2>
            ...
            <div className="pt-2">
              <button
                ...
                className="text-sm text-brand hover:text-brand-700 font-medium flex items-center gap-1"
              >
          ...
          <Card className="p-6 space-y-4">
            <h2 className="font-semibold text-gray-900 dark:text-white flex items-center gap-2">
              <Clock className="w-4 h-4 text-brand" /> Préparation & Nutrition
            </h2>
          ...
          <Card className="p-6 space-y-4">
            <h2 className="font-semibold text-gray-900 dark:text-white flex items-center gap-2">
              <Ruler className="w-4 h-4 text-brand" /> Allergènes
            </h2>
          ...
          <Card className="p-6 space-y-4">
            <h2 className="font-semibold text-gray-900 dark:text-white flex items-center gap-2">
              <Tag className="w-4 h-4 text-brand" /> Variantes
            </h2>
        ...
        <div className="space-y-6">
              ...
              {[
                {
                  ...
                  key: 'isPopular',
                  desc: 'Afficher dans la section populaires',
                },
                ...
                <label key={opt.key} className="flex items-start gap-3 cursor-pointer">
                  <input
                    ...
                    onChange={() => update(opt.key, !(form as any)[opt.key])}
          ...
          <Card className="p-6 space-y-4">
            ...
            <Input
              ...
              placeholder="Ex: épicé, végétarien, local"
            />
          ...
          <Card className="p-6 space-y-4">
            <h3 className="font-semibold text-gray-900 dark:text-white text-sm">
              <Eye className="w-4 h-4 inline mr-1" /> SEO
            </h3>
            <Input
              label="Titre SEO"
              value={form.seoTitle}
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 text-sm border border-gray-200 dark:border-gray-700 rounded-lg bg-transparent resize-none"
                rows={2}
                maxLength={160}
          ...
          <Button type="submit" className="w-full" isLoading={createMenuItem.isPending}>
