      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          ...
          <div className="mt-4">
            ...
            >
              {showPromo ? '— Masquer promo' : '+ Ajouter une promotion'}
            </button>
            {showPromo && (
        ...
        <Card>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-semibold">Préparation & Nutrition</h3>
          </div>
        ...
        <Card>
          ...
          <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-8 text-center hover:border-brand/40 transition-colors">
            ...
            <p className="text-sm text-gray-500">Photos du plat</p>
        ...
        <Card>
          ...
          <div className="flex flex-wrap items-center gap-4 mb-4">
            ...
            <label className="flex items-center gap-2 text-sm">
              <input
                type="checkbox"
                checked={form.isStar || false}
                onChange={(e) => update('isStar', e.target.checked)}
                className="rounded border-gray-300 text-brand focus:ring-brand"
              />{' '}
              Star
            </label>
