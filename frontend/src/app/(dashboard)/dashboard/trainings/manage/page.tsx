...
export default function ManageTrainingsPage() {
  ...
  const confirmDelete = async () => {
    ...
    await deleteTraining.mutateAsync(deleteTarget);
              ...
              {filtered.map((t: any) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/dashboard/trainings/manage/${t.id}`}
                  ...
                  <td className="px-4 py-3 text-center">
                    {t._count?.TrainingLesson || t.lessons || 0}
                  </td>
                  ...
                  <td className="px-4 py-3 text-right">
                    <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <Link
                        href={`/dashboard/trainings/manage/${t.id}/edit`}
