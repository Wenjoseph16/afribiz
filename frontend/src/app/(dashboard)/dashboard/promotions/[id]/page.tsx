...
export default function PromotionDetailPage() {
  ...
  if (!promotion)
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <p className="text-gray-500">Promotion introuvable</p>
      </div>
    );
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
      ...
      <div
        className={cn('rounded-2xl p-8 text-white', {
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 text-sm opacity-90">
              ...
              <span className="font-bold text-2xl">
                {p.discountValue}
                {p.discountType === 'PERCENTAGE' ? '%' : ' FCFA'}
              </span>
            </div>
          </div>
          <span
          ...
          <div className="space-y-4">
              ...
              <div className="space-y-3 text-sm">
                ...
                {p.minPurchase && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-900 dark:text-gray-100">
                      {Number(p.minPurchase).toLocaleString()} FCFA
                    </span>
                  </div>
                )}
                {p.maxDiscount && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-900 dark:text-gray-100">
                      {Number(p.maxDiscount).toLocaleString()} FCFA
                    </span>
                  </div>
                )}
                {p.usageLimit && (
            ...
            {p.code && (
              <Card padding="lg">
                ...
                <div className="flex items-center gap-2">
                  <span className="font-mono text-lg font-bold text-brand px-3 py-1.5 rounded-lg bg-brand-50 dark:bg-brand-900/30">
                    {p.code}
                  </span>
                  <button
                    onClick={copyCode}
      ...
      <ConfirmationModal
        ...
        description="Cette action est irréversible. La promotion sera définitivement supprimée."
