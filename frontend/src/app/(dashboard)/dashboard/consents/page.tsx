...
const SHARE_LEVELS = [
  ...
  { value: 'SCORE_ONLY', label: 'Score uniquement', desc: 'Partager seulement le score agrégé' },
  {
    ...
    desc: 'Partager des données anonymisées pour analyse',
  },
  {
    value: 'DETAILED',
    label: 'Données détaillées',
    desc: 'Partager toutes les données (avec consentement explicite)',
  },
];
...
const CATEGORIES = [
  ...
  { value: 'COMMERCIAL', label: 'Données commerciales', desc: 'Commandes, produits, clients' },
  {
    ...
    desc: 'Performance, délais, fiabilité',
  },
      ...
      {showCreateForm && (
        <Card>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-2">
                Types de partenaires autorisés
              </label>
              ...
              <Card key={consent.id}>
                <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <p className="font-semibold text-gray-900 dark:text-gray-100">
                          {category?.label || consent.category}
                        </p>
                        {isActive ? (
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    {isActive && (
                      <Button variant="ghost" size="xs" onClick={() => handleRevoke(consent.id)}>
