...
export default function PortfolioCategoriesPage() {
  ...
  const handleDelete = async (id: string) => {
    setDeleting(id);
    try {
      await apiClient.deletePortfolioCategory(id);
      refetch();
    } catch (err) {
      console.error(err);
    }
    ...
    <div className="animate-fade-in space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        <Card className="p-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-[10px] text-gray-500">Catégories</p>
        ...
        <Card className="p-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-[10px] text-gray-500">Projets liés</p>
        ...
        <Card className="p-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-[10px] text-gray-500">Couleurs</p>
              <p className="text-lg font-bold">
                {new Set(categories.map((c: any) => c.color)).size}
              </p>
            </div>
          </div>
        </Card>
      ...
      {categories.length === 0 ? (
        <Card className="text-center py-12">
          <Folder className="h-12 w-12 text-gray-200 dark:text-gray-700 mx-auto mb-3" />
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      {cat._count?.items || cat.itemCount || 0} projet(s)
                    </p>
                  </div>
                </div>
