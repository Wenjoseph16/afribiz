...
export default function PortfolioDetailPage() {
  ...
  if (!item)
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <p className="text-gray-500">Élément introuvable</p>
      </div>
    );
        ...
        <div className="flex items-start justify-between">
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              {p.projectDate &&
                new Date(p.projectDate) > new Date(Date.now() - 180 * 24 * 60 * 60 * 1000) && (
                ...
                {p.projectDate && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-900 dark:text-gray-100">
                      {new Date(p.projectDate).toLocaleDateString('fr-FR', {
                        day: 'numeric',
                        month: 'long',
                        year: 'numeric',
                      })}
              ...
              {[
                {
                  ...
                  label: 'Projet ajouté au portfolio',
                  icon: History,
                },
                {
                  date: p.projectDate ? new Date(p.projectDate) : null,
                  label: 'Date du projet',
                  icon: CalendarDays,
                },
                {
                  date: p.updatedAt ? new Date(p.updatedAt) : null,
