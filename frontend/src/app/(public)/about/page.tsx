...
const values = [
  {
    ...
    title: 'Notre Mission',
    description:
      "Donner à chaque entrepreneur africain les outils numériques pour développer son business, où qu'il soit.",
  },
  {
    icon: Users,
    title: 'Notre Vision',
    description:
      "Devenir la plateforme de référence pour les PME africaines en construisant l'écosystème entrepreneurial le plus inclusif du continent.",
  },
  {
    icon: Heart,
    title: 'Nos Valeurs',
    description:
      'Innovation, accessibilité, inclusion et impact local. Nous croyons en la puissance de la technologie pour transformer les économies africaines.',
  },
  {
    icon: Globe,
    title: 'Notre Impact',
    description:
      'Déjà +10 000 entrepreneurs actifs, +50 types de business, dans +15 pays africains. Et nous ne faisons que commencer.',
  },
];
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-950">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <motion.div {...fadeInUp} className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-gray-100 tracking-tight mb-6">
              ...
              <span className="gradient-text">business africain</span>
            </h1>
            <p className="text-lg sm:text-xl text-gray-500 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
              AfriBiz est née d&apos;une conviction : les entrepreneurs africains méritent des
              outils numériques puissants, accessibles et adaptés à leurs réalités.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <motion.div {...fadeInUp} className="text-center max-w-3xl mx-auto">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed text-left">
              <p>
                Tout a commencé en 2023, quand notre fondateur, Koffi Amégnon, a réalisé que la
                plupart des solutions SaaS disponibles ne répondaient pas aux besoins spécifiques
                des entrepreneurs africains. Trop chères, trop complexes, ou tout simplement pas
                adaptées aux réalités locales.
              </p>
              <p>
                AfriBiz a été conçue dès le départ pour être mobile-first, intégrer les moyens de
                paiement locaux (Mobile Money), et offrir des fonctionnalités modulaires que chaque
                entrepreneur peut activer selon ses besoins.
              </p>
              <p>
                Aujourd&apos;hui, AfriBiz est utilisée par des milliers d&apos;entrepreneurs à
                travers l&apos;Afrique, des artisans aux PME en pleine croissance. Et nous
                continuons d&apos;innover chaque jour.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeInUp} className="text-center mb-14">
            ...
            <p className="text-lg text-gray-500 dark:text-gray-400">
              Des passionnés de technologie au service de l&apos;entrepreneuriat africain.
            </p>
          </motion.div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {team.map((member, i) => (
              ...
              >
                <div
                  className={`w-20 h-20 mx-auto rounded-2xl bg-gradient-to-br ${member.color} flex items-center justify-center text-white text-xl font-bold mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300`}
                >
                  {member.initials}
                </div>
          ...
          >
            ...
            <div className="relative">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4 tracking-tight">
                Rejoignez l&apos;aventure AfriBiz
              </h2>
              <p className="text-emerald-100/80 max-w-lg mx-auto mb-8">
                Créez votre business gratuitement et faites partie de la révolution numérique
                africaine.
              </p>
              <Link
                href="/signup"
                className="inline-flex items-center gap-2 bg-white text-brand px-8 py-3.5 rounded-xl font-semibold hover:bg-emerald-50 hover:shadow-xl transition-all"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 pb-8">
        <AdSlot page="ABOUT" position="BOTTOM_BANNER" />
      </div>
      <Footer />
    </main>
  );
