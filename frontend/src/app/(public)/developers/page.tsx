...
const benefits = [
  {
    ...
    description: "Accédez à toutes les fonctionnalités d'AfriBiz via notre API REST documentée.",
  },
  {
    icon: BookOpen,
    title: 'Documentation complète',
    description: 'Guides, SDK, exemples de code et tutoriels pour intégrer AfriBiz rapidement.',
  },
  {
    icon: CreditCard,
    title: 'Revenue Sharing',
    description: "Gagnez de l'argent à chaque fois qu'un business utilise votre module.",
  },
  {
    icon: Globe,
    title: 'Marché panafricain',
    description: 'Publiez vos modules sur tout le continent africain.',
  },
  {
    icon: Shield,
    title: 'Sandbox sécurisé',
    description: 'Développez et testez dans un environnement isolé avant la mise en production.',
  },
  {
    icon: Users,
    title: 'Communauté active',
    description: "Échangez avec d'autres développeurs et obtenez du support technique.",
  },
];
...
const steps = [
  {
    ...
    description: 'Inscrivez-vous en tant que développeur sur AfriBiz.',
  },
  {
    number: '02',
    title: 'Explorez la documentation',
    description: 'Accédez à notre documentation complète et aux SDK disponibles.',
  },
  {
    number: '03',
    title: 'Développez votre module',
    description: 'Utilisez notre API pour créer des fonctionnalités personnalisées.',
  },
  {
    number: '04',
    title: 'Soumettez et publiez',
    description: 'Soumettez votre module pour validation et publiez-le sur la Marketplace.',
  },
  {
    number: '05',
    title: "Gagnez de l'argent",
    description: 'Recevez une part des revenus générés par votre module à chaque utilisation.',
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-500 dark:text-gray-400 max-w-xl leading-relaxed mb-8">
                ...
                thèmes visuels — et gagnez de l&apos;argent à chaque fois qu&apos;un business les
                utilise.
              </p>
              <div className="flex flex-col sm:flex-row items-start gap-3">
                <Link
                  href="/signup"
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-indigo-500 text-white px-7 py-3.5 rounded-xl text-base font-semibold hover:shadow-xl hover:shadow-purple-500/25 transition-all group"
                >
                ...
                <Link
                  href="#documentation"
                  className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl text-base font-semibold bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all"
                >
            ...
            >
              <div className="bg-gray-900 dark:bg-gray-800 rounded-2xl overflow-hidden shadow-2xl border border-gray-700">
                ...
                <div className="p-5 font-mono text-xs sm:text-sm leading-relaxed">
                  ...
                  <div className="mt-2">
                    <span className="text-gray-500">{'// Module Orange Money Pro'}</span>
                  </div>
                  <div>
                  ...
                  <div className="ml-4">
                    <span className="text-gray-500"> apiKey: process</span>
                    <span className="text-gray-300">.</span>
                    <span className="text-cyan-300">env</span>
                    <span className="text-gray-300">.</span>
                    <span className="text-amber-300">AFRIBIZ_API_KEY</span>
                    <span className="text-gray-500">,</span>
                  </div>
                  <div className="ml-4">
                  ...
                  <div className="mt-2">
                    <span className="text-gray-500">{'// Nouveau module de paiement'}</span>
                  </div>
                  <div>
                    <span className="text-purple-400">const</span>
                    ...
                    <span className="text-gray-300"> api.</span>
                    <span className="text-cyan-300">registerModule</span>
                    <span className="text-gray-500">({String.fromCharCode(123)}</span>
                  </div>
                  <div className="ml-4">
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeInUp} className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="text-lg text-gray-500 dark:text-gray-400">
              Un écosystème complet avec tous les outils dont vous avez besoin.
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <motion.div {...fadeInUp} className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="text-lg text-gray-500 dark:text-gray-400">
              Créez votre premier module en 5 étapes simples.
            </p>
          </motion.div>
            ...
            {steps.map((step, i) => (
              ...
              >
                <div className="flex flex-col items-center">
                  ...
                  {i < steps.length - 1 && (
                    <div className="w-0.5 h-8 bg-purple-200 dark:bg-purple-800 mt-2" />
                  )}
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-purple-100/80 max-w-lg mx-auto mb-8">
                Créez, publiez et monétisez vos modules sur la marketplace panafricaine.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  href="/signup"
                  className="inline-flex items-center gap-2 bg-white text-purple-700 px-8 py-3.5 rounded-xl font-semibold hover:bg-purple-50 hover:shadow-xl transition-all"
                >
                  Créer mon compte développeur <ArrowRight className="h-5 w-5" />
                </Link>
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 bg-white/10 text-white px-8 py-3.5 rounded-xl font-semibold hover:bg-white/20 backdrop-blur-sm border border-white/10 transition-all"
                >
                  Nous contacter
                </Link>
              </div>
