        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none space-y-6 text-gray-600 dark:text-gray-400">
            <motion.div {...fadeInUp}>
              ...
              <p>
                Nous collectons les informations que vous nous fournissez directement lors de la
                création de votre compte : nom, prénom, adresse email, numéro de téléphone et
                informations de paiement. Nous collectons également des données d&apos;utilisation
