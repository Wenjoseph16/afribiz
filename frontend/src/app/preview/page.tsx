...
const features = [
  {
    icon: Smartphone,
    title: 'Mobile-first',
    desc: "Gérez votre business depuis n'importe quel smartphone",
  },
  { icon: Globe, title: 'Page publique', desc: 'Votre vitrine en ligne avec domaine personnalisé' },
  {
    icon: CreditCard,
    title: 'Paiements locaux',
    desc: 'Mobile Money, cartes, espèces — vos clients choisissent',
  },
  {
    icon: Shield,
    title: 'Escrow sécurisé',
    desc: "Fonds protégés jusqu'à confirmation de livraison",
  },
  {
    icon: BarChart3,
    title: 'Statistiques',
    desc: 'Suivez vos ventes, clients et tendances en temps réel',
  },
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <motion.div {...fadeInUp} className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="mt-5 text-lg sm:text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
              Créez votre compte business, complétez l&apos;onboarding en 5 minutes, et accédez à un
              tableau de bord puissant pour gérer tout votre entreprise.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-8">
              ...
              <button
                onClick={() => scrollToSection('dashboard-demo')}
          ...
          >
            {[
              ...
              <div
                key={i}
                className="text-center p-4 rounded-2xl bg-white/70 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/30"
              >
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeInUp} className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
              Chaque étape débloque des fonctionnalités. Prenez le temps de bien renseigner vos
              informations pour offrir la meilleure expérience à vos clients.
            </p>
          </motion.div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <h3
                            className={`font-semibold ${isActive ? 'text-gray-900 dark:text-gray-100' : 'text-gray-700 dark:text-gray-300'}`}
                          >
                            {step.title}
                          </h3>
                        </div>
                ...
                {activeOnboarding === 0 && (
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-brand to-emerald-400 flex items-center justify-center text-white text-xl font-bold">
                        MB
                      </div>
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          Lomé, Togo · ouverte depuis janvier 2025
                        </p>
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      {['Lun-Ven: 08h-19h', 'Sam: 09h-17h'].map((h) => (
                        <div
                          key={h}
                          className="p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 text-sm text-gray-600 dark:text-gray-400"
                        >
                          {h}
                        </div>
                      ))}
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      <Star className="h-4 w-4 fill-amber-400 text-amber-400" /> 4.8 (120 avis) ·
                      Vérifié ✓
                    </div>
                    <div className="p-4 rounded-xl bg-brand-50 dark:bg-brand-950/30 border border-brand/20">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Vos clients voient toutes vos informations. L'onboarding vous guide pas à
                        pas.
                      </p>
                    </div>
                  </div>
                ...
                {activeOnboarding === 1 && (
                  <div className="space-y-4">
                    <div className="flex items-center gap-2 text-sm font-medium text-gray-500 mb-2">
                      Modules activés <span className="text-brand">● 3 actifs</span>
                    </div>
                      ...
                      {[
                        {
                          ...
                          name: 'E-Commerce',
                          status: 'Actif',
                          desc: '24 produits · 89 commandes',
                        },
                        {
                          icon: Calendar,
                          name: 'Réservations',
                          status: 'Actif',
                          desc: '15 réservations ce mois',
                        },
                        {
                          icon: FileText,
                          name: 'Facturation',
                          status: 'Actif',
                          desc: '34 factures générées',
                        },
                      ].map((mod) => {
                        ...
                        return (
                          ...
                          >
                            <div className="w-9 h-9 rounded-lg bg-brand-50 dark:bg-brand-900/30 flex items-center justify-center">
                              <MIcon className="w-4 h-4 text-brand" />
                            </div>
                            <div className="flex-1">
                    ...
                    <div className="p-4 rounded-xl bg-blue-50 dark:bg-blue-950/30 border border-blue-200/50">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Activez uniquement les modules pertinents pour votre activité. Vous pourrez
                ...
                {activeOnboarding === 2 && (
                  <div className="space-y-4">
                    <div className="grid grid-cols-3 gap-3 mb-3">
                      {[
                        { label: 'Vues ce mois', value: '1 240' },
                        { label: 'Paniers', value: '89' },
                        { label: 'Taux conv.', value: '38%' },
                      ].map((s) => (
                        <div
                          key={s.label}
                          className="text-center p-3 rounded-xl bg-gray-50 dark:bg-gray-700/30"
                        >
                          <p className="text-lg font-bold text-gray-900 dark:text-gray-100">
                            {s.value}
                          </p>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-3 mb-3">
                      {[
                        ...
                        <div
                          key={s.label}
                          className="p-3 rounded-xl bg-gray-50 dark:bg-gray-700/30"
                        >
                          <p className="text-xs text-gray-500">{s.label}</p>
          ...
          <motion.div
            {...fadeInUp}
            className="text-center mt-12 p-8 rounded-2xl bg-gradient-to-r from-brand-50 to-emerald-50 dark:from-brand-950/30 dark:to-emerald-950/30 border border-brand/10"
          >
          ...
          >
            ...
            <div className="flex items-center gap-2 px-4 py-3 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700">
              ...
              <div className="flex-1 mx-4">
                <div className="bg-white dark:bg-gray-700 rounded-lg px-3 py-1.5 text-xs text-gray-400 text-center truncate border border-gray-200 dark:border-gray-600 flex items-center justify-center gap-2">
                  <Shield className="h-3 w-3 text-emerald-500" /> maboutique.afribiz.app/dashboard
                </div>
              </div>
              <div className="flex items-center gap-1 text-xs text-gray-400">
                <Bell className="h-3.5 w-3.5" />
                <span className="w-4 h-4 rounded-full bg-brand text-white flex items-center justify-center text-[9px] font-bold">
                  3
                </span>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
                {kpiData.map((kpi, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="relative p-3 rounded-xl bg-gray-50 dark:bg-gray-700/30 border border-gray-100 dark:border-gray-700/50 hover:border-brand/20 hover:shadow-sm transition-all group/kpi cursor-default"
                    ...
                    >
                      ...
                      <span
                        className={`text-[10px] font-medium ${kpi.up ? 'text-emerald-600' : 'text-red-500'}`}
                      >
                        {kpi.change}
                      </span>
                      {showTooltip === i && (
                        ...
                        >
                          {kpi.label === 'Ventes du jour'
                            ...
                            : kpi.label === 'Clients'
                              ? '👥 Voyez qui achète chez vous'
                              : kpi.label === 'Commandes'
                                ? '📦 Gérez toutes vos commandes'
                                : kpi.label === 'Avis clients'
                                  ? '⭐ Répondez aux avis de vos clients'
                                  : kpi.label === 'Revenu mensuel'
                ...
                <div className="lg:col-span-2">
                  ...
                  <div className="space-y-2">
                    {recentOrders.map((order) => (
                      <div
                        key={order.id}
                        className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-gray-700/30 hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors group cursor-default"
                      >
                        ...
                        <div className="text-right">
                          ...
                          <span
                            className={`text-[10px] px-2 py-0.5 rounded-full font-medium ${order.statusColor}`}
                          >
                            {order.status}
                          </span>
                        </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      {
                        icon: Bell,
                        title: 'Rappel : stock faible',
                        desc: 'Sac Tissé Main : 3 restants',
                        time: 'Il y a 1h',
                        color: 'text-red-600',
                        bg: 'bg-red-50',
                      },
                      ...
                      return (
                        <div
                          key={i}
                          className="flex items-start gap-3 p-3 rounded-xl bg-gray-50 dark:bg-gray-700/30 hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors cursor-default"
                        >
                          <div
                            className={`w-8 h-8 rounded-lg ${notif.bg} flex items-center justify-center shrink-0`}
                          >
        ...
        <div className="max-w-4xl mx-auto text-center">
          <motion.div {...fadeInUp}>
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 rounded-full text-sm font-medium mb-5 border border-emerald-200/50">
              ...
              Pourquoi bien faire l&apos;onboarding ?
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-gray-100 tracking-tight mb-6">
              Un onboarding bien rempli ={' '}
              <span className="gradient-text">un business qui cartonne</span>
            </h2>
          </motion.div>
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="flex items-center justify-center gap-4 sm:gap-6 mt-8 text-xs text-emerald-200/70">
                ...
                <span className="flex items-center gap-1.5">
                  <Check className="h-3.5 w-3.5" />5 min d&apos;onboarding
                </span>
                <span className="flex items-center gap-1.5">
                  <Check className="h-3.5 w-3.5" />
                  Support 24/7
