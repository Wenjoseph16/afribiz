...
function Counter({
  ...
  return (
    <div
      ref={ref}
      className="flex items-start gap-3 p-4 rounded-xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-100 dark:border-gray-700/50 hover:shadow-md transition-all"
    >
...
export function BusinessStats({
  ...
  const stats = [
    ...
    {
      value: business.foundedYear ? new Date().getFullYear() - business.foundedYear : 0,
      suffix: ' ans',
      label: "D'experience",
