...
export function QuoteRequestModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError('');
    try {
      const res = await apiClient.post('/public/businesses/' + businessSlug + '/quote-request', {
        ...form,
        serviceName,
      });
      if (!res.data.success) {
        ...
        {success ? (
          <div className="p-8 text-center">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
              Votre demande de devis a \u00e9t\u00e9 transmise. Le professionnel vous contactera
              sous peu.
            </p>
            <button
              onClick={onClose}
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="p-6 pt-4 space-y-4">
              ...
              {error && (
                <p className="text-xs text-red-600 bg-red-50 dark:bg-red-900/20 p-2 rounded-lg">
                  {error}
                </p>
              )}
              <button
