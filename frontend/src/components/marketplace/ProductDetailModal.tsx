...
export function ProductDetailModal({ product, isOpen, onClose }: ProductDetailModalProps) {
  ...
  const promos = [
    badge > 0
      ? {
          label: `-${badge}% sur ce produit`,
          desc: `Économisez ${savings.toLocaleString()} FCFA`,
          icon: Percent,
        }
      : null,
  ...
  const handleContactBusiness = () => {
    ...
    router.push(
      `/dashboard/messages?businessId=${product.businessId}&businessName=${encodeURIComponent(product.businessName)}`
    );
  };
          ...
          <div className="relative bg-gray-50 dark:bg-gray-800/50">
            <div className="aspect-square md:aspect-[4/5] relative overflow-hidden">
              ...
              {badge > 0 && (
                <div className="absolute top-4 left-4 flex items-center gap-1.5 bg-gradient-to-r from-red-500 to-red-600 text-white px-3 py-1.5 rounded-xl text-sm font-bold shadow-lg">
                  <Percent className="w-4 h-4" />-{badge}%
                </div>
              )}
            ...
            <div className="p-4">
              <button
                ...
                className="w-full flex items-center gap-3 p-3 rounded-xl bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all group border border-gray-200 dark:border-gray-700"
              >
                ...
                <div className="flex-1 text-left">
                  <p className="text-sm font-semibold text-gray-900 dark:text-gray-100 group-hover:text-brand transition-colors">
            ...
            <div className="flex items-baseline gap-3 mb-6">
              {badge > 0 ? (
                <>
                  ...
                  <span className="text-sm font-bold text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/30 px-2 py-0.5 rounded-lg">
                    -{badge}%
                  </span>
                </>
              ) : product.price > 0 ? (
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="flex items-center border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
                <button
                  ...
                  className="w-10 h-10 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors font-medium text-lg"
                >
                  -
                </button>
                <span className="w-12 h-10 flex items-center justify-center text-sm font-semibold text-gray-900 dark:text-gray-100 border-x border-gray-200 dark:border-gray-700">
                  {quantity}
                </span>
                <button
            ...
            <div className="space-y-3 mb-6">
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl font-semibold text-sm bg-gradient-to-r from-brand to-emerald-400 text-white hover:shadow-lg hover:shadow-brand/20 transition-all duration-200"
                >
              ...
              <button
                onClick={handleVisitStore}
                className="w-full flex items-center justify-center gap-2 py-3 rounded-xl font-medium text-sm text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200"
              >
