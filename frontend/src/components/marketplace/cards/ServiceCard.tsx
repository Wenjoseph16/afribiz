      ...
      <div className="flex gap-4 p-4 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-brand/20 hover:shadow-card transition-all duration-200 group">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex gap-2 mt-3">
            ...
            <Link
              href={`/business/${item.businessSlug || item.id}`}
              className="text-xs font-medium text-brand border border-brand/20 px-4 py-1.5 rounded-lg hover:bg-brand-50 dark:hover:bg-brand-900/20 transition-colors inline-block"
            >
              Devis
            </Link>
    ...
    <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-brand/20 hover:shadow-card transition-all duration-200 overflow-hidden group">
      ...
      <div className="p-4">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <Link
            href={`/business/${item.businessSlug || item.id}`}
            className="flex-1 text-xs font-medium text-brand border border-brand/20 rounded-lg py-2 hover:bg-brand-50 dark:hover:bg-brand-900/20 transition-colors inline-block text-center"
          >
            Devis
          </Link>
          {item.layawayOfferId && (
