...
const actions = [
  ...
  },
  {
    ...
    href: '/dashboard/explore?type=product',
    icon: Search,
    color: 'text-blue-600 bg-blue-50',
  },
  {
    label: 'Rechercher un service',
    href: '/dashboard/explore?type=service',
    icon: ShoppingBag,
    color: 'text-purple-600 bg-purple-50',
  },
  {
    label: 'Rechercher un événement',
    href: '/dashboard/explore?type=event',
    icon: Calendar,
    color: 'text-orange-600 bg-orange-50',
  },
  {
    label: 'Consulter ses favoris',
    href: '/dashboard/favorites',
    icon: Heart,
    color: 'text-red-600 bg-red-50',
  },
  {
    label: 'Devenir Business',
