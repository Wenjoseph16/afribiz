...
export const BUSINESS_CORE_NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Formations', href: '/dashboard/trainings/manage', icon: 'GraduationCap', module: 'TRAINING' },
  ...
  },
  {
    label: 'Ventes',
    items: [
      { label: 'Commandes', href: '/dashboard/business/orders', icon: 'ShoppingCart', module: 'ORDERS' },
      { label: 'Réservations', href: '/dashboard/bookings/calendar', icon: 'CalendarCheck', module: 'BOOKINGS' },
      { label: 'Événements', href: '/dashboard/events', icon: 'CalendarDays', module: 'EVENTS' },
      { label: 'Devis & Factures', href: '/dashboard/quotes', icon: 'FileText', module: 'QUOTES_INVOICES' },
      { label: 'Créances', href: '/dashboard/debts-payments', icon: 'Wallet', module: 'DEBTS_PAYMENTS' },
      { label: 'Abonnements', href: '/dashboard/subscriptions', icon: 'Repeat', module: 'SUBSCRIPTIONS' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Litiges', href: '/dashboard/disputes', icon: 'Scale', module: 'DISPUTES' },
    ],
  },
  {
    label: 'Équipe',
    items: [
      { label: 'Employés', href: '/dashboard/employees', icon: 'Briefcase', module: 'EMPLOYEES' },
      { label: 'Planning', href: '/dashboard/planning', icon: 'Clock', module: 'PLANNING' },
      { label: 'Tâches avancées', href: '/dashboard/tasks', icon: 'Wrench', module: 'ADVANCED_TASKS' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Défis & Quêtes', href: '/dashboard/afriscore/gamification', icon: 'Award' },
      ...
      { label: 'Data Hub', href: '/dashboard/datahub', icon: 'Database' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Marketplace', href: '/dashboard/marketplace', icon: 'Store', module: 'MODULE_MARKETPLACE' },
