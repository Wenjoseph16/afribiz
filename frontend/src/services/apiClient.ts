...
import { injectCash, injectCockpit } from './api/cash';
...
import { injectCatalogAttachments } from './api/catalogAttachments';
import { injectNegotiations } from './api/negotiations';
import { injectSuppliers } from './api/suppliers';
import { injectAffiliates } from './api/affiliates';
...
import { injectSatisfaction } from './api/satisfaction';
...
injectCatalogAttachments(_api);
injectNegotiations(_api);
injectSuppliers(_api);
injectAffiliates(_api);
injectLives(_api);
