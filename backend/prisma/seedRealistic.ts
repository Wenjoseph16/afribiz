...
async function seedDevelopers() {
  ...
  const modules: any[] = [
    ...
    // En attente de validation admin (flux de sécurité : DRAFT → soumission → PENDING_REVIEW → admin → PUBLISHED)
    { id: 'devmod-5', developerId: 'devprof-1', name: 'ComptaPro', slug: 'compta-pro', description: 'Facturation et comptabilité simplifiées pour TPE', price: 18000, currency: 'FCFA', isFree: false, isActive: true, isPublished: false, status: 'DRAFT', isVerified: false, isFeatured: false, category: 'Finance', tags: ['facturation', 'comptabilité'], dashboardUrl: 'https://compta-pro.app.afribiz.com/dashboard', sidebarLabel: 'ComptaPro', sidebarIcon: 'Calculator' },
    { id: 'devmod-6', developerId: 'devprof-2', name: 'WhatsApp Broadcast', slug: 'whatsapp-broadcast', description: 'Campagnes WhatsApp en masse avec templates', price: 9500, currency: 'FCFA', isFree: false, isActive: true, isPublished: false, status: 'DRAFT', isVerified: false, isFeatured: false, category: 'Marketing', tags: ['whatsapp', 'campagnes'], dashboardUrl: 'https://wa-broadcast.app.afribiz.com/dashboard', sidebarLabel: 'WhatsApp Broadcast', sidebarIcon: 'MessageCircle' },
  ];
