...
jest.mock('../../lib/businessModules', () => ({ resolveBusinessModules: jest.fn().mockReturnValue(['PRODUCTS', 'PORTFOLIO']) }));
jest.mock('../../events/publishers', () => ({ publishOnboardingCompleted: jest.fn(), publishBusinessRegistered: jest.fn() }));
...
const mockBiz = {
  id: 'biz-1', slug: 'joshbiz', name: 'JoshBiz', type: 'FREELANCE',
  shortDescription: 'Dev web', logo: 'http://localhost:3001/uploads/logo.webp',
  coverImage: 'http://localhost:3001/uploads/banner.webp',
  skills: ['Web', 'Design'], certifications: ['CFA — LMBI'],
  certificationImages: ['http://localhost:3001/uploads/cert.webp'],
  experience: 3, managerBio: 'Passionné par le web',
  ...
  address: 'Agoe', city: 'Lome', country: 'Togo', phone: '+22892528688',
  latitude: 6.1, longitude: 1.2, isActive: true, deletedAt: null,
};
