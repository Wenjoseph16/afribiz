...
const typeMapping: Record<DomainEventType, NotificationType> = {
  ...
  BUSINESS_REGISTERED: NotificationType.NEW_MESSAGE,
  BUSINESS_KYC_SUBMITTED: NotificationType.NEW_MESSAGE,
  ...
  FAVORITE_ADDED: NotificationType.SYSTEM,
  FAVORITE_REMOVED: NotificationType.SYSTEM,
...
const eventTitles: Record<DomainEventType, string> = {
  ...
  BUSINESS_REGISTERED: 'Business inscrit',
  BUSINESS_KYC_SUBMITTED: 'Dossier KYC soumis',
