...
const DEFAULT_VERIFICATION: VerificationSettings = {
  mode: 'badge_only',
  description:
    "La vérification d'identité est optionnelle. Les utilisateurs vérifiés obtiennent un badge de confiance.",
};
...
export async function updateVerificationSettings(
  ...
  await (prisma as any).platformSetting.upsert({
    ...
    create: {
      ...
      description: 'Configure le niveau de vérification requis pour les utilisateurs',
    },
  });
