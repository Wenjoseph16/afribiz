...
export const getUserActivity = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getBusinesses = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getBusinessById = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const updateBusinessVerification = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response) => {
    ...
    res.json({
      success: true,
      data: business,
      message: action === 'verify' ? 'Commerce vérifié avec succès' : 'Commerce refusé',
    });
  }
);

export const getDevelopers = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { search, status, verified } = req.query;
    const page = parseInt(req.query.page as string) || 1;
    const limit = parseInt(req.query.limit as string) || 10;
...
export const getDeveloperById = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getModules = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getPayments = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getEscrows = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { status } = req.query;
    const page = parseInt(req.query.page as string) || 1;
    const limit = parseInt(req.query.limit as string) || 10;
...
export const getAdminEscrows = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { status } = req.query;
    const page = parseInt(req.query.page as string) || 1;
    const limit = parseInt(req.query.limit as string) || 10;
...
export const getAdminEscrowStats = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAdminPaymentStats = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const validatePayment = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAdminSubscriptionStats = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAdminSecurityStats = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAdminSecurityAdmins = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const page = parseInt(req.query.page as string) || 1;
...
export const getAdminSecuritySessions = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const page = parseInt(req.query.page as string) || 1;
    const limit = parseInt(req.query.limit as string) || 15;
...
export const getAdminSecurityAttempts = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const page = parseInt(req.query.page as string) || 1;
    const limit = parseInt(req.query.limit as string) || 15;
...
export const getAdminSecurityBlacklist = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const page = parseInt(req.query.page as string) || 1;
    const limit = parseInt(req.query.limit as string) || 15;
...
export const blockAdminSecurityIp = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { ip } = req.body;
...
export const unblockAdminSecurityIp = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAdminSecurityJournal = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const page = parseInt(req.query.page as string) || 1;
    const limit = parseInt(req.query.limit as string) || 15;
...
export const getDisputesStats = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAdminMarketplaceItems = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const updateAdminMarketplaceItem = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { type, id, action } = req.params;
    const result = await adminService.updateAdminMarketplaceItem(
      type,
      id,
      action as 'feature' | 'unfeature'
    );
...
export const getAdminAdCampaigns = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { status, search } = req.query;
    const page = parseInt(req.query.page as string) || 1;
    const limit = parseInt(req.query.limit as string) || 10;
    const result = await adminService.getAdminAdCampaigns({
      status: status as string,
      search: search as string,
      page,
      limit,
...
export const getAdminAdStats = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAdminAdRevenue = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAdminAfriScoreStats = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAdminAfriScoreRules = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const updateAdminAfriScoreRules = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAdminAfriScoreBadges = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const page = parseInt(req.query.page as string) || 1;
    const limit = parseInt(req.query.limit as string) || 10;
...
export const getAdminAfriScoreHistory = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const page = parseInt(req.query.page as string) || 1;
    const limit = parseInt(req.query.limit as string) || 10;
...
export const getAdminAfriScoreAudit = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const page = parseInt(req.query.page as string) || 1;
    const limit = parseInt(req.query.limit as string) || 10;
...
export const getAdminPartners = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const page = parseInt(req.query.page as string) || 1;
...
export const approveAdminPartner = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const suspendAdminPartner = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const revokeAdminPartner = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAdminDataAccessLogs = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const page = parseInt(req.query.page as string) || 1;
    const limit = parseInt(req.query.limit as string) || 50;
...
export const getAdminPlatformAnalytics = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getSupportTickets = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getDisputes = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { status } = req.query;
    const page = parseInt(req.query.page as string) || 1;
    const limit = parseInt(req.query.limit as string) || 10;
...
export const getDataReports = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getSecurityLogs = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getSystemLogs = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getApiKeys = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const page = parseInt(req.query.page as string) || 1;
    const limit = parseInt(req.query.limit as string) || 10;
...
export const getAdminAuditLog = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
/**
 * GET /admin/payouts
 * List all developer payout requests with optional status/developerId filters
 */
export const getAllPayouts = catchAsyncErrors(async (req: AuthenticatedRequest, res: Response) => {
  const { status, developerId } = req.query;
  const developerModulesService = await import('../services/developerModules');
  const payouts = await developerModulesService.getAllPayouts({
    status: status as string,
 ...
 * Approve a pending developer payout, notify the developer
 */
export const approvePayout = catchAsyncErrors(async (req: AuthenticatedRequest, res: Response) => {
  if (!req.user) throw new AppError('Non authentifié', 401);
  const developerModulesService = await import('../services/developerModules');
  const result = await developerModulesService.approvePayout(req.params.id, req.user.id);
  res.json(result);
});

/**
 * POST /admin/payouts/:id/reject
 * Reject a pending developer payout with optional reason, notify the developer
 */
export const rejectPayout = catchAsyncErrors(async (req: AuthenticatedRequest, res: Response) => {
  if (!req.user) throw new AppError('Non authentifié', 401);
  const developerModulesService = await import('../services/developerModules');
  const result = await developerModulesService.rejectPayout(
    req.params.id,
    req.user.id,
    req.body.reason
  );
