...
export const getCampaignById = catchAsyncErrors(
...
export const getActiveAds = catchAsyncErrors(async (req: Request, res: Response) => {
  ...
  const ads = await adsService.getActiveAdCreatives(
    page as string,
    position as string,
    country as string
  );
...
export const trackConversion = catchAsyncErrors(async (req: Request, res: Response) => {
  const { campaignId, ...data } = req.body;
  await adsService.trackConversion(campaignId, data);
  res.status(201).json({ success: true, message: 'Conversion enregistrée' });
});
...
export const adminGetAllCampaigns = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response) => {
    const filters = req.query;
...
export const adminValidateCampaign = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response) => {
...
export const adminRejectCampaign = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response) => {
    const { id } = req.params;
...
export const adminSuspendCampaign = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response) => {
    const { id } = req.params;
    const { reason } = req.body;
...
export const adminGetPackages = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response) => {
...
export const adminCreatePackage = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response) => {
    const data = req.body;
...
export const adminUpdatePackage = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response) => {
    const { id } = req.params;
    const data = req.body;
...
export const adminGetRevenue = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response) => {
...
export const generateInvoice = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response) => {
    const { id } = req.params;
