...
import * as contentReportService from '../services/contentReportService';
...
export const getPlatformSettingsByCategory = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getVerificationSettings = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const updateVerificationSettings = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getFeatureFlags = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { scope, enabled } = req.query as { scope?: string; enabled?: string };
    const flags = await adminFeaturesService.getFeatureFlags({ scope, enabled });
    res.json({ success: true, data: flags });
  }
);

export const getFeatureFlag = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAdminRoles = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAdminPermissions = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getUserRoles = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAutomationRules = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { trigger, status } = req.query as { trigger?: string; status?: string };
    const rules = await adminFeaturesService.getAutomationRules({ trigger, status });
    res.json({ success: true, data: rules });
  }
);

export const getAutomationRule = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAutomationExecutionLogs = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAutomationTriggers = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAutomationActionTypes = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getCmsPages = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getCmsPage = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const createCmsPage = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getCmsCategories = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const createCmsCategory = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const updateCmsCategory = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const deleteCmsCategory = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getFormTemplates = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getFormTemplate = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const createFormTemplate = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const updateFormTemplate = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const deleteFormTemplate = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const activateFormTemplate = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getFormSubmissions = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getFormSubmission = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getNotificationTemplates = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { type, channel } = req.query as { type?: string; channel?: string };
    const templates = await adminFeaturesService.getNotificationTemplates({ type, channel });
    res.json({ success: true, data: templates });
  }
);

export const getNotificationTemplate = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const createNotificationTemplate = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const updateNotificationTemplate = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const deleteNotificationTemplate = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getNotificationTypes = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getNotificationChannels = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getPlatformCopilotConfig = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const updatePlatformCopilotConfig = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getBusinessCopilotConfig = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const updateBusinessCopilotConfig = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const config = await adminFeaturesService.updateBusinessCopilotConfig(
...
export const getPlatformHealthCtrl = catchAsyncErrors(
...
export const getMediaModerationItems = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getMediaModerationItem = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const reportMedia = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { contentType, contentId, reason, description } = req.body;
    const item = await adminFeaturesService.reportMedia(
      contentType,
      contentId,
      req.user!.id,
      reason,
...
export const reportMediaViaContentReport = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { type, referenceId, reason, description } = req.body;
    const report = await contentReportService.createReport({
      reporterId: req.user!.id,
      type: (type as CommentTargetType) || 'BUSINESS',
      referenceId: referenceId || req.body.contentId,
      reason: reason?.trim() || 'Signalement admin',
      description,
    });
    res
      .status(201)
      .json({ success: true, data: report, message: 'Contenu signalé (via contentReport)' });
  }
);

export const approveMedia = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const rejectMedia = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const flagMedia = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { reason } = req.body;
...
export const getModerationStats = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getCommissionConfigs = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getCommissionConfig = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const createCommissionConfig = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const updateCommissionConfig = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const deleteCommissionConfig = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getUserWarnings = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const issueWarning = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { reason, description, action } = req.body;
    const warning = await adminFeaturesService.issueWarning(
      req.params.userId,
      req.user!.id,
      reason,
      description,
...
export const getAllWarnings = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAllSubscriptionPlans = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getSubscriptionPlan = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const createSubscriptionPlan = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const updateSubscriptionPlan = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const deleteSubscriptionPlan = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const addPlanPrivilege = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const updatePlanPrivilege = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const removePlanPrivilege = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getBackups = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const createBackup = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const restoreBackup = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getBackupDownloadUrl = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const toggleAutoBackup = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    ...
    res.json({
      success: true,
      data: result,
      message: 'Sauvegarde automatique ' + (enabled ? 'activée' : 'désactivée'),
    });
  }
);
...
export const recomputeAllAfriScores = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAfriScoreRules = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const updateAfriScoreRules = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAdminStories = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const updateAdminStoryStatus = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
...
export const deleteAdminStory = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
...
export const getAdminShorts = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const updateAdminShortStatus = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
    const { status } = req.body;
...
export const deleteAdminShort = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
...
export const getAdminLives = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const updateAdminLiveStatus = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
    const { status } = req.body;
    const live = await prisma.live.update({
      where: { id },
      data: { status: status as LiveStatus },
    });
...
export const getMonetizationAudit = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getDeveloperCommissions = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    ...
    const developers = profiles.map((profile) => ({
      ...
      commission: Math.round(profile.modules.reduce((sum, m) => sum + Number(m.price) * 0.2, 0)),
      netRevenue: Math.round(profile.modules.reduce((sum, m) => sum + Number(m.price) * 0.8, 0)),
    }));
...
export const getAdminCoupons = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAdminPromotions = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getAdminCouponStats = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const [
      totalCoupons,
      activeCoupons,
...
export const disableAdminCoupon = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getPlatformRevenue = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const period = (req.params.period || req.query.period || '30d') as
      | '7d'
      | '30d'
      | '90d'
      | '1y'
...
export const getCampaigns = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getCampaign = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const createCampaign = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const campaign = await prisma.campaign.create({ data: req.body as Prisma.CampaignCreateInput });
    res.status(201).json({ success: true, data: campaign, message: 'Campagne creee' });
  }
);

export const updateCampaign = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const campaign = await prisma.campaign.update({
      where: { id: req.params.id },
      data: req.body as Record<string, any>,
    });
    res.json({ success: true, data: campaign, message: 'Campagne mise a jour' });
  }
);

export const deleteCampaign = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const startCampaign = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const campaign = await prisma.campaign.update({
      where: { id: req.params.id },
      data: { status: 'ACTIVE', startedAt: new Date() },
    });
    res.json({ success: true, data: campaign, message: 'Campagne demarree' });
  }
);

export const getCampaignTemplates = catchAsyncErrors(
  async (_req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
export const getCampaignExecutionLogs = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
    const logs = await prisma.campaignExecutionLog.findMany({
