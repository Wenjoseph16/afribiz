...
export const getMarketingStats = catchAsyncErrors(
...
export const triggerBirthdayCampaign = catchAsyncErrors(
...
export const triggerInactiveCheck = catchAsyncErrors(
  async (req: AuthenticatedRequest, res: Response) => {
