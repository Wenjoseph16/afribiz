...
// ============================================
// MODULE DEMAND & MATCHING
// ============================================

export type ModuleDemandStatus = 'OPEN' | 'MATCHED' | 'IN_PROGRESS' | 'COMPLETED' | 'CANCELLED';
export type MatchStatus = 'PENDING' | 'ACCEPTED' | 'REJECTED' | 'COMPLETED';
export type ProposalType = 'EXISTING' | 'CUSTOM_BUILD';
...
export interface ModuleDemand {
  ...
  status: ModuleDemandStatus;
  isUrgent: boolean;
  approvedDeveloperId?: string | null;
  matches?: ModuleMatch[];
  createdAt: string;
  updatedAt: string;
}
